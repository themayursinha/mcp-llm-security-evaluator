...
class DataRedactor:
    ...
    def redact(self, text: str, custom_patterns: Dict[str, List[str]] = None) -> str:
    ...
    def get_redaction_stats(self, original_text: str, redacted_text: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'redaction_effectiveness': (total_original - total_redacted) / total_original if total_original > 0 else 0,
...
def redact(text: str, custom_patterns: Dict[str, List[str]] = None) -> str:
